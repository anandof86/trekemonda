...
const CreateCollectionComponent = (props) => {
    ...
    const onSubmit = (data) => {
        ...
        if (props.formStatus === 'Add') {
            axios({
                url: 'http://3.109.40.48:8080/api/collection/beta',
                method: 'post',
                responseType: 'json',
                data: data,
                headers: {
            ...
            axios({
                url: 'http://3.109.40.48:8080/api/collection/v1/beta/' + props.currentRow.id,
                method: 'put',
                responseType: 'json',
                data: data,
                headers: {
